...
import '../../css_files/c_registration.css';
...
const CustomerRegistration = () => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        const { fullname, email, password, address, phone } = state;
        ...
        await fetch('/customer-registration', {
            ...
            body: JSON.stringify({
                fullname:fullname, email: email, password: password, address: address, phone:phone
            })
    ...
    return (
        <>
            ...
            blur={{ min: -1, max: 1 }}
            strength={600}>
            <div class="CR-main-body">
                <Container fluid>
                    <Row>
                        <Col>
                            <br/>
                            <h1 className="c-h1">Customer Registration</h1>
                            <hr/>
