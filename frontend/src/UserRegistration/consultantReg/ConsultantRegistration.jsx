...
import '../../css_files/consultant_reg.css';
...
const ConsultantRegistration = () => {
    ...
    const [state, setstate] = useState({
        fullname: '', email: '', password: '', address: '', cnic: '', charges: '', phone:''
    })
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        const { fullname, email, password, address, cnic, charges, phone } = state;
        // console.log(cnic);
        await fetch('/consultant-registration', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
            },
            body: JSON.stringify({
                fullname: fullname, email: email, password: password, address: address, cnic: cnic, charges: charges, phone:phone
            })
    ...
    return (
        <>
            ...
            blur={{ min: -1, max: 1 }}
            strength={600}>
                <div class="CO-main-body">
                    <Container fluid>
                        <Row>
                            <Col>
                                <br />
                                <h1 className="co-h1">Consultant Registration</h1>
                                <hr />
                                ...
                                <Form.Group>
                                    <Form.Label>Charges (per cattle) </Form.Label>
