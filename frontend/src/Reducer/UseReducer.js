...
export const PreviousComponentStatusReducer = (state, action) => {
    if (action.payload != null) {
        // console.log(action.payload);
        return action.payload;
    }
...
export const Total_Amount_Cart_Reducer = (state, action) => {
    if (action.payload != null) {
        // console.log(action.payload);
        return action.payload;
    }
...
export const Total_Amount_Procced_Reducer = (state, action) => {
    if (action.payload != null) {
        // console.log(action.payload);
        return action.payload;
    }
...
export const Edit_CattleID_Reducer = (state, action) => {
    if (action.payload != null) {
        // console.log(action.payload);
        return action.payload;
    }
