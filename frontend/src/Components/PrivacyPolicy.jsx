            ...
            <AnimationOnScroll animateOnce={true} delay={400} animateIn="animate__fadeIn">
                <Row>
                    <div>
                        ...
                        <p className="htb-para">
                        Welcome to the daraz.pk website (the "Site") operated by Jade E Services Pakistan Pvt Limited (Registration Number: '0080047). We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.
                        ...
                        <p className="htb-para">We may collect various pieces of information if you seek to place an order for a product with us on the Site.
